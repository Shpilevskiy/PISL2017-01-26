package by.it.group473601.gorbachik.lesson07;
...
public class C_EditDist {
    ...
    String getDistanceEdinting(String one, String two) {
        ...
        int[][] array;
        array = new int[one.length() + 1][two.length() + 1];
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group473601/gorbachik/lesson07/dataABC.txt");
